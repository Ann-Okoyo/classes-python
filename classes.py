class Account:
    ...
    def transactions(self):
        for transaction in self.deposits:
            print(transaction)
bank=Account(4567,"Ann",14,8)
ban=Account(4567,"Ann",14,8)
bank.deposit(71)
ban.deposit(3)
bank.transactions
...
def repay_loan(self,amount):
        ...
        if amount>self.loan_balance:
            addition=self.loan_balance-amount
...
def transfer(self,amount,other_account):
        ...
        if self.balance> amount:
            return
        self.balance -= amount
        other_account.check_deposit(self,amount)class Account:
          bankAccount="Cooperative"
def __init__(self,balance,accNumber,userName, withdrawals) :
        self.balance=balance
        self.accNumber=accNumber
        self.userName=userName
